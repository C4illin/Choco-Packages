...
$packageArgs = @{
  ...
  url64bit               = 'https://github.com/Qalculate/libqalculate/releases/download/v5.8.2/qalculate-5.8.2-x64.msi'
  validExitCodes         = @(0, 3010)
  checksum64             = 'bac004fcaeb9715c9f4f79435d7e12233866eabf31fbdf8f3ed64fbdb1568fd7'
